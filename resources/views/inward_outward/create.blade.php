...
<head>
    ...
    <title>Material Inward Outward Quantity || Create</title>
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Add Material Inward/Outward Quantity</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Material Inward/Outward Quantity</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form method="post" action="{{ url('/inward_outward_quantity_master') }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="pd-20 card-box mb-30">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <select name="material_name_id" id="material_name_id" class="form-control @error('material_name_id') is-invalid @enderror">
                                                    ...
                                                    <option value="{{ $key }}" @if ($key == old('material_name_id')) Selected @endif>{{ $value }}</option>
                                                    @endforeach
												</select>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 col-md-4">
                                                    <input type="text" name="date" id="date" class="form-control datepicker-default @error('date') is-invalid @enderror" value="{{ old('date') }}" placeholder="DD/MM/YYYY">
                                                    @error('date')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-sm-4 col-md-4">
                                                    <input type="number" name="inward_outward_quantity" id="inward_outward_quantity" class="form-control @error('inward_outward_quantity') is-invalid @enderror" value="{{ old('inward_outward_quantity') }}" placeholder="Enter Material Inward Outward Quantity.">
    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            $('#category_id').on('change', function() {
                ...
                $("#material_name_id").html('');
                $.ajax({
                    type: "POST",
                    url: "{{ url('material_name_list') }}",
                    data: {
                    ...
                    success: function(res) {
                        ...
                        $.each(res.materialnamelist, function(key, value) {
                            $("#material_name_id").append('<option value="' + value
                                .id + '">' + value.material_name + '</option>');
                        });
                    }
                });
            });
