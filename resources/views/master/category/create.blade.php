				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form method="post" action="{{ url('/category_master') }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="pd-20 card-box mb-30">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="raw_material" id="raw_material" class="form-control @error('raw_material') is-invalid @enderror" value="{{ old('raw_material') }}" placeholder="Enter Raw Material.">
                                                @error('raw_material')
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="finish_goods" id="finish_goods" class="form-control @error('finish_goods') is-invalid @enderror" value="{{ old('finish_goods') }}" placeholder="Enter Finish Goods.">
                                                @error('finish_goods')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="spares" id="spares" class="form-control @error('spares') is-invalid @enderror" value="{{ old('spares') }}" placeholder="Enter Spares.">
                                                @error('spares')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="machines" id="machines" class="form-control @error('machines') is-invalid @enderror" value="{{ old('machines') }}" placeholder="Enter Machines.">
                                                @error('machines')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="others" id="others" class="form-control @error('others') is-invalid @enderror" value="{{ old('others') }}" placeholder="Enter Others.">
                                                @error('others')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
