                                    ...
                                    <div class="pd-20 card-box mb-30">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="raw_material" id="raw_material" class="form-control" readonly value="{{ $data->raw_material }}" placeholder="Enter Raw Material.">

                                            </div>

                                            <label class="col-sm-2">Finish Goods : <span style="color:red;">*</span></label>
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="finish_goods" id="finish_goods" class="form-control " readonly value="{{ $data->finish_goods }}" placeholder="Enter Finish Goods.">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="spares" id="spares" class="form-control " readonly value="{{ $data->spares }}" placeholder="Enter Spares.">

                                            </div>

                                            <label class="col-sm-2">Machines : <span style="color:red;">*</span></label>
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="machines" id="machines" class="form-control " readonly value="{{ $data->machines }}" placeholder="Enter Machines.">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="others" id="others" class="form-control " readonly value="{{ $data->others }}" placeholder="Enter Others.">
