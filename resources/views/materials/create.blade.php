				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form method="post" action="{{ url('/materials_master') }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="pd-20 card-box mb-30">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="material_name" id="material_name" class="form-control @error('material_name') is-invalid @enderror" value="{{ old('material_name') }}" onkeypress="return onlyAlphanumerics(event)" placeholder="Enter Material Name.">
                                                @error('material_name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="opening_balance" id="opening_balance" class="form-control @error('opening_balance') is-invalid @enderror" value="{{ old('opening_balance') }}" onkeypress="return only_decimal(event)" placeholder="Enter Opening Balance.">
