				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Edit Material</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form method="post" action="{{ route('materials_master.update', $data->id) }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="pd-20 card-box mb-30">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="material_name" id="material_name" class="form-control @error('material_name') is-invalid @enderror" value="{{ $data->material_name }}" onkeypress="return onlyAlphanumerics(event)" placeholder="Enter Material Name.">
                                                @error('material_name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <input type="text" name="opening_balance" onkeypress="return only_decimal(event)" id="opening_balance" class="form-control @error('opening_balance') is-invalid @enderror" value="{{ $data->opening_balance }}" placeholder="Enter Opening Balance.">
