                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <span class="ml-1">Materials</span>
                        </div>
                    </div>
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('materials_master.create') }}" class="btn btn-primary">+ Add new</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example4" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('materials_master.show', $value->id) }}" class="btn btn-sm btn-primary"><i class="la la-eye"></i></a>
                                                </td>
                                                <td>
                                                    <a href="{{ route('materials_master.edit', $value->id) }}" class="btn btn-sm btn-warning"><i class="la la-pencil"></i></a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('materials_master.destroy', $value->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
